...
7. Next is the “**Add tools and information**” section. Click “**Recommend Tools**” and let Now Assist suggest a tool based on your agent's description and instructions.

<figure><img src="../.gitbook/assets/2.1-recommend-tools-click.png" alt=""><figcaption></figcaption></figure>

   Now Assist will generate a suggestion — this takes a few seconds.

<figure><img src="../.gitbook/assets/2.1-recommend-tools-loading.png" alt=""><figcaption></figcaption></figure>

   It will add a **Greetings tool** (a Script tool that displays a greeting to the user). Click “**Save and continue**”.

<figure><img src="../.gitbook/assets/2.1-greetings-tool-added.png" alt=""><figcaption></figcaption></figure>
...
* **Action**: The next step that the agent feels it needs to take.
* **Action Inputs:** The inputs the AI Agent decided to pass on to the tool or, in this case, the built-in fall-back capability

{% hint style="warning" %}
**If your very first test immediately fails** with a Thought like "I am unable to complete the task since I have no instructions or actions" and the agent just gives up (no question asked back to you): this is a known, transient timing issue on freshly-published agents, not a problem with your setup. **Wait about 2 minutes and click "Continue to Test Chat response" again** — no changes needed. The retry should work cleanly and walk through the real conversation described below.
{% endhint %}
